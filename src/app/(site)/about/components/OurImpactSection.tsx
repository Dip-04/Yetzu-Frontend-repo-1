export default function OurImpactSection() {
  return (
    <section className="w-full px-4 sm:px-6 md:px-12 lg:px-20 xl:px-[108px] py-12 md:py-14 lg:py-16 bg-[linear-gradient(180deg,_#FFFFFF_0%,_#E2E7FF_50.01%,_#FFFFFF_100%)]">
