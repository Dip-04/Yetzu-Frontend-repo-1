...
export default function ResourceCards() {
  return (
    <section className="w-full bg-gradient-to-b from-blue-50 to-white py-10 px-4 sm:px-6 md:px-12 lg:px-20 xl:px-[108px]">
      <div className="max-w-[1224px] mx-auto text-center mb-10 text-center">
