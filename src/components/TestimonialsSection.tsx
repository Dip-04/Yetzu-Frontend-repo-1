...
export default function Testimonials({
  ...
  return (
    <section className="relative bg-white px-4 sm:px-6 md:px-12 lg:px-20 xl:px-[108px] py-12 md:py-14 lg:py-16 flex flex-col items-center gap-10 overflow-hidden">
